                  ...
                  <div class="tab-base">
                     ...
                     <div class="tab-content">
                        ...
                        <div id="tab2" class="tab-pane fade <?php if ($current_tab == 'tab2') {
                           ...
                           <form method="post" action="<?php $link->link("edit_admin", frontend, '&edit=' . $load . '&tab=' . $current_tab); ?>" enctype="multipart/form-data" id="editLoginInfo">
                        ...
                        <div id="tab3" class="tab-pane fade <?php if ($current_tab == 'tab3') {
                           ...
                           <form method="post" action="<?php $link->link("edit_admin", frontend, '&edit=' . $load . '&tab=' . $current_tab); ?>" enctype="multipart/form-data" id="editProfileImage">
